...
namespace NibsInventoryManagementSystem
{
    public partial class MainForm : Form
    {
        ...
        private void customer_button_Click(object sender, EventArgs e)
        {
            ...
            adform.displayInventoryManagement();
            adform.displayTotalItems();
        }
        ...
        private void resetsize_button_Click(object sender, EventArgs e)
        {
        ...
        private void adduser_button_Click(object sender, EventArgs e)
        {
            ...
            AdminAddUsers adform = adminAddUsers1 as AdminAddUsers;
            if (adform != null)
            {
                adform.refreshData();
            }

            adform.displayAllUsersData();
        }
        ...
        public void colorManagement()
        {
            ...
            adduser_button.BackColor = Form1.appC;
            ...
            adduser_button.FlatAppearance.MouseOverBackColor = ControlPaint.Light(Form1.appC);
            adduser_button.FlatAppearance.MouseDownBackColor = ControlPaint.Light(Form1.appC);
